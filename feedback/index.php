...
$form['form1'] = array(
	'fields' => array(
		...
		'checkbox' => array(
			'title' => 'Согласие с информцией о защите персональных данных',
            'validate' => array(
				'minlength' => '3',
				'maxlength' => '3',
			),
			'messages' => array(
				'preg' => 'Поле «%1$s» возможно содержит ошибку',
				'minlength' => 'Вы не поставили отметку о согласии на обработку персональных данных',
				'maxlength' => 'Вы не поставили отметку о согласии на обработку персональных данных',
			)
		),
...
/*        'marka' => array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма заявки на стоимость авто',
		'title' => 'Форма заявки на стоимость авто',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'no-reply@avtovykup-34.ru',
		'from_name' => 'avtovykup-34.ru',
		'to_email' => 'ivanovdmitriy2013@icloud.com',
		'to_email_2' => 'a.aleshenko@gmail.com',
		'geoip' => false,
		'referer' => true,
		'type' => 'plain',
		'tpl' => false,
...
$form['form2'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма заказать звонок/задать вопрос',
		'title' => 'Форма заказать звонок/задать вопрос',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'no-reply@avtovykup-34.ru',
		'from_name' => 'avtovykup-34.ru',
...
if(isset($form[$act])) {
   ...
   $sb = array(); // subject и body
    ...
    if(count($error) == 0) {
      ...
      $toEmail2 = trim($form['cfg']['to_email2'], " ,");
...
*/
      ...
      $mail = mail('ivanovdmitriy2013@icloud.com', $sb['subject'], $sb['body'], $headers);
      $mail = mail('streetmakarov@gmail.com', $sb['subject'], $sb['body'], $headers);
      $mail = mail('mail@corp-seo.ru', $sb['subject'], $sb['body'], $headers);
    $mail = mail('a.aleshenko@gmail.com', $sb['subject'], $sb['body'], $headers);
///////////////////////////////////////////////////////////////////////////////////////////
